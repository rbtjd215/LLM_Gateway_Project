...
| 평가 지표 | V1 (정규식 전용) | V4 (CPU 환경) | V4 (GPU 환경) |
|---|:---:|:---:|:---:|
...
>   * **오차율 주석:** V4(CPU)와 V4(GPU) 간의 0.x% 수치 변동은 동일한 7B 모델을 사용할 때 발생하는 생성형 AI 특유의 난수 기반 무작위성(통계적 오차) 범위 내이며, 두 환경에서의 보안 지능 수준은 수학적으로 동일함.
