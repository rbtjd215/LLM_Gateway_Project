# AutoCore AI Security Gateway API 명세서

본 문서는 프론트엔드 애플리케이션 및 외부 클라이언트가 AutoCore Gateway Backend(FastAPI)와 통신하기 위한 RESTful API 규격을 정의한다.
